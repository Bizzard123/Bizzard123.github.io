    ...
    <div className='wow fadeInUp' style={{ padding: '5%',display:'flex',flexDirection:'column',backgroundColor:'white', color: 'black' }}>
      ...
      <div className='cardContainerUsp'>
        ...
        <div className='cardUsp' style={{backgroundColor:'#feefdb'}}>
          <img src="https://img.freepik.com/free-vector/hand-drawn-credit-assessment-concept_23-2149171651.jpg?w=740&t=st=1712006743~exp=1712007343~hmac=f1e34657540334516c0d74bde4af047e8424cef61578b7aa6f47133be4a97be5" alt="UserFriendly" />
          <div className='cardContentUsp'>
